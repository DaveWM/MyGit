...
namespace MyGitTests
{
    public class TestBase
    {
        ...
        public void Init()
        {
            ...
            App.Container.RegisterInstance<IGitHubClient>(GitHubClientMock.Object);
            App.Container.RegisterInstance<ILoginService>(LoginServiceMock.Object);
            App.Container.RegisterInstance<ILocalStorageService>(LocalStorageServiceMock);
            App.Container.RegisterInstance<INavigationService>(MockNavigationService.Object);
        }
    }
}
